...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/seven-face-auth/verify.js":[function(require,module,exports) {
const verify = `
...
},{}],"node_modules/seven-face-auth/register.js":[function(require,module,exports) {
const register = `
<div class="app_header box">
    <div class="video_container circle">
        <video playsinline autoplay id="video" class="circle"></video>
...
},{}],"node_modules/seven-face-auth/style.js":[function(require,module,exports) {
styles = `
.app_body {
  display: flex;
...
},{}],"node_modules/seven-face-auth/index.js":[function(require,module,exports) {
"use strict";
...
function templatefaceui(options) {
  ...
  addStyle(_style.styles); // include css

  includeJS("https://cdnjs.cloudflare.com/ajax/libs/axios/0.20.0/axios.min.js"); // ajouter style sur la page global
  ...
  if (options.path_url === "login") {
    ...
    var e = document.createElement("div");
    e.className = "app_body";
    e.innerHTML = _register.register;
    container.append(e);
  } else {// # none
    // get error
  }
...
module.exports = {
  templatefaceui: templatefaceui
};
},{"./verify":"node_modules/seven-face-auth/verify.js","./register":"node_modules/seven-face-auth/register.js","./style":"node_modules/seven-face-auth/style.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _sevenFaceAuth = require("seven-face-auth");
